-- Insert sample users
INSERT INTO "user" (
    id, user_id, last_name, first_name, email_address,
    supervisor_user_id, title_text, create_user_id, create_dttm,
    update_user_id, update_dttm
) VALUES
      (1, 'super123', 'Smith', 'Anna', 'anna.smith@example.com', null, 'Director', 1, now(), 1, now()),
      (2, 'john123', 'Doe', 'John', 'john.doe@example.com', 'super123', 'Developer', 1, now(), 1, now()),
      (3, 'jane456', 'Roe', 'Jane', 'jane.roe@example.com', 'super123', 'Analyst', 1, now(), 1, now());
